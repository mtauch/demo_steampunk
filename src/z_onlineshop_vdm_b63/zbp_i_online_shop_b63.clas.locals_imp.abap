...
CLASS lsc_ZI_ONLINE_SHOP_B63 DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_ONLINE_SHOP_B63 IMPLEMENTATION.

  METHOD save_modified.
    DATA :  lt_online_shop_as TYPE STANDARD TABLE OF zshop_as_b63,
            ls_online_shop_as TYPE zshop_as_b63.

    IF zbp_i_online_shop_b63=>cv_pr_mapped-purchaserequisition IS NOT INITIAL.
        LOOP AT zbp_i_online_shop_b63=>cv_pr_mapped-purchaserequisition ASSIGNING FIELD-SYMBOL(<fs_pr_mapped>).
    ...
    IF create-online_shop IS NOT INITIAL.
        ...
        INSERT zshop_as_b63 FROM TABLE @lt_online_shop_as.
    ENDIF.
